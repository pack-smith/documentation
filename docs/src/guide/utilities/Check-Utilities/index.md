...
- [**`isFunction`**](/guide/utilities/Check-Utilities/isFunction)
- [**`isNull`**](/guide/utilities/Check-Utilities/isNull)
- [**`isNumber`**](/guide/utilities/Check-Utilities/isNumber)
- [**`isObject`**](/guide/utilities/Check-Utilities/isObject)
- [**`isString`**](/guide/utilities/Check-Utilities/isString)
